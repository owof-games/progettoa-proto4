...
{elia_acting.senzatetto2: <i>Informazioni sul personaggio Elia</i> #slot-1}
{elia_acting.senzatetto2: Elia: Paola voleva rilevare il pub per trasformarlo in un rifugio per senzatetto. E Greta ha detto cose terribili e ripetuto che avrebbe fatto di tutto per fermarla. #slot-2}
...
{cb_first_tier_antico_pugnale.primoCheck:<i>Informazioni sull'antico pugnale rituale</i> #slot-1}
...
{cb_first_tier_bottiglia_di_vino.primoCheck: <i>Informazioni sulla bottiglia di vino</i> #slot-1}
{cb_first_tier_bottiglia_di_vino.primoCheck: Un negroamaro di prestigio. Probabilmente costa più di quanto tu possa guadagnare in metà mese. #slot-2}

    ~ notebookPage = 11

{cb_first_tier_flaconcino_asma.primoCheck: <i>Informazioni sul flaconcino dell'asma</i> #slot-1}
{cb_first_tier_flaconcino_asma.primoCheck: Un comune flaconcino. O, con un po' di fantasia, il periscopio di un sottomarino. #slot-2}
...
{matteo_acting.limetta: Matteo: Pacchiana, economica, e con tracce di schifo? Deve essere di Greta. #slot-3}
    ...
    ~ notebookPage = 13
{cb_first_tier_sigaretta_elettronica.primoCheck: <i>Informazioni sulla sigaretta elettronica</i> #slot-1}
{cb_first_tier_sigaretta_elettronica.primoCheck: Ha l'odore di un deodorante per il bagno, ma per il resto, niente di particolare. #slot-2}


    ~ notebookPage = 14
{cb_first_tier_cibo.primoCheck: <i>Informazioni sulla torta</i> #slot-1}
{cb_first_tier_cibo.primoCheck: Il paradiso di un dodicenne: cioccolata, crema di arachidi, fragole, biscottini sbriciolati. La adori. #slot-2}
...
{marryMeStorylet.matteoSiSposa && hardTrueFeelingsStorylet.matteoGreta: <b>Quali sono le intenzioni di Matteo sul matrimonio?</b> #slot-1}
    ...
    ~ notebookPage = 16
{matteo_acting.paolaZeca && worstBestManStorylet.paolaZeca: <b>La relazione tra Paola e Zeca</b> #slot-1}
...
{info_elia: <i>Informazioni su Elia</i>#slot-1}  
    


{paola_talking_second_tier.money: Elia per Zeca è la gallina delle uova d'oro, ma di galline non se ne trovano due in questa vita.#slot-2}  
{greta_talking_second_tier.indagini2: Greta: Elia sta usando l'amicizia con Matteo per usare il sindacato contro Paola.#slot-3}  
{greta_talking_second_tier.allestimento3: Greta: Ero in giro con Elia a sistemare i tavoli della altre sale. #slot-4} 
{greta_talking_second_tier.indagini3: Greta: E io che, stupida, coprivo i furti di denaro di Elia in azienda.#slot-5}  
{trueLoveStorylet.promise: Elia: Abbracciami. Te lo prometto Zeca: basta grattini con Greta o qualsiasi altra persona.#slot-6}  
...
{liarCallLiarStorylet.indagini: Zeca: La polizia ha avuto accesso a dati personali di Paola. Dati che solo la sua segretaria potrebbe avere.#slot-4}
{liesAndPromisesStorylet.promise: Elia: Ti amo, Greta.#slot-5}  
{notABigSecretPartOneStorylet.allestimento: Matteo: Certo: Greta ed Elia potevano recuperare pure del vino decente. E hanno lasciato in tutta la stanza il puzzo delle loro cose da scenografi. Due cose dovevano fare: riparare le seggiole, allestire il buffet. E hanno fatto un disastro in tutte e due le occasioni.#slot-6}  
...
{matteo_talking_second_tier.lettera2: Matteo: Solo due persone in questo posto mossono minacciare qualcuno: Paola e Zeca.#slot-6}  
    ...
    ~ notebookPage = 8
{cb_second_tier_bottiglia_di_vino.primoCheck or paola_is_dead.vino: <i>Informazioni sulla bottiglia di vino</i>#slot-1}  
{cb_second_tier_bottiglia_di_vino.primoCheck: Il liquido è inquieto e torbido, e si agita nella bottiglia come fosse dotato di vita propria.#slot-2}  
{paola_is_dead.vino: Rimane solo un goccio sul fondo. Le labbra di Paola hanno lo stesso colore.#slot-3}  
{paola_talking_second_tier.vino: Paola: Amo da morire questo vino.#slot-4}  
{zeca_talking_second_tier.allestimento3: Zeca: Sì, la boccia l'abbiamo presa Matteo ed io.#slot-5}  
...
{cb_second_tier_sigaretta_elettronica.primoCheck or paola_is_dead.sigaretta: <i>Informazioni sulla sigaretta elettronica</i> #slot-1}
{cb_second_tier_sigaretta_elettronica.primoCheck: Morte tascabile. #slot-2}
{paola_is_dead.sigaretta: Il dispenser del liquido è completamnte svuotato. #slot-3}
{paola_talking_second_tier.sigaretta: Paola: Io vivo di sigaretta elettronica. Adoro i suoi sapori chimici, la possibilità di fumarla ovunque. #slot-4}
{greta_talking_second_tier.allestimento2: Greta: Ed ecco la cosa divertente: che grazie alle sigarette elettroniche ora basta versare il veleno sulla pelle e bang, è fatta! Puoi uccidere qualcuno. #slot-5}
...
{matteo_talking_second_tier.torta: Matteo: Strano: Zeca e io abbiamo preso la roba al supermercato, ma non ricordo questa torta! #slot-5}
    ...
    ~ notebookPage = 12
{paola_talking_second_tier.foto2: <i>Informazioni sulla foto</i> #slot-1}
{paola_talking_second_tier.foto2: Due persone. In un locale. Con l'urgenza di divorarsi. #slot-2}
...
{contraddizione_lettera: <b>A chi è indirizzata la lettera di Paola?</b> #slot-1}


    {
        - contraddizione_lettera:
            {elia_talking_second_tier.indagini: Elia: Allora ti dico un segreto: Greta ha dato a Matteo molte informazioni sui conti dell'azienda. Vuole aiutarlo con questa cosa del sindicato, così che Matteo possa sindicare meglio sindicando Paola e venendo sindicato dai colleghi del sindicato. #slot-2}
            {greta_talking_second_tier.indagini: Greta: Beh: Paola sta cercando far estromettere Elia dalla Londar. #slot-3}
            A chi è destinata la lettera? #slot-4
