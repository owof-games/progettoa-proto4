...
namespace FMODUnity
{
    public static class CodeGeneration
    {
            ...
            IEnumerable<string> pluginFunctions)
        {
            ...
            file.WriteLine(
                "        public static void {0}(FMOD.System coreSystem, Action<FMOD.RESULT, string> reportResult)",
            ...
            if (pluginFunctions.Any())
            {
                ...
                foreach (string pluginFunction in pluginFunctions)
                {
                    file.WriteLine();
                    file.WriteLine(
                        "            result = FMOD5_System_RegisterDSP(coreSystem.handle, {0}(), IntPtr.Zero);",
                        pluginFunction);
                    file.WriteLine("            reportResult(result, \"Registering static plugin '{0}'\");",
                        pluginFunction);
                }
            }
