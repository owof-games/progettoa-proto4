...
#pragma warning restore 0618
            ...
            if (subObjectFields.Any())
            {
                ...
                foreach (FieldInfo subObjectField in subObjectFields)
                {
                    ...
                    if (value == null || (value is Object && !(value as Object)))
                    {
                        continue;
                    }
                    ...
                    if (subObjectField.FieldType.IsValueType || !parents.Contains(value))
                    {
                        if (value is IEnumerable && !(value is string))
                        {
                            ...
                            for (;;)
                            {
                                ...
                                {
                                    foreach (Task t in GetGenericUpdateTasks(item,
                        ...
                        {
                            foreach (Task t in GetGenericUpdateTasks(value,
                                         FieldPath(subObjectPath, subObjectField.Name), parents))
                            {
                                yield return t;
                            }
                        }
