...
namespace FMODUnity
{
    ...
    public class SettingsEditor : Editor
    {
        ...
        private static readonly string[] OverlayLocations = new string[]
            { "TopLeft", "TopCenter", "TopRight", "BottomLeft", "BottomCenter", "BottomRight", "Center", "VR", };
        ...
        private static readonly SPEAKERMODE[] SpeakerModeValues = new SPEAKERMODE[]
        {
            SPEAKERMODE.STEREO,
        ...
        private void DisplayPositionRect(string label, Platform platform,
        ...
        private void DisplayOutputMode(string label, Platform platform)
        {
            if (platform.ValidOutputTypes != null)
            {
                ...
                {
                    currentIndex = 0;
                    platform.OutputTypeName = Enum.GetName(typeof(OUTPUTTYPE), OUTPUTTYPE.AUTODETECT);
                }
