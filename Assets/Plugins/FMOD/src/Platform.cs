...
namespace FMODUnity
{
    ...
    public abstract class Platform : ScriptableObject
    {
        ...
        internal virtual bool IsFMODStaticallyLinked
        {
            get { return false; }
        }
        ...
        {
            get { return PropertyAccessors.OverlayPosition.Get(this); }
        }

        public int OverlayFontSize
        {
            get { return PropertyAccessors.OverlayFontSize.Get(this); }
        }
        ...
        internal static class PropertyAccessors
        {
            ...
            public static readonly PropertyAccessor<ScreenPosition> OverlayPosition =
                new PropertyAccessor<ScreenPosition>(properties => properties.OverlayPosition, ScreenPosition.TopLeft);

            public static readonly PropertyAccessor<int> OverlayFontSize =
                new PropertyAccessor<int>(properties => properties.OverlayFontSize, 14);
        ...
        internal List<string> ChildIdentifiers
        {
