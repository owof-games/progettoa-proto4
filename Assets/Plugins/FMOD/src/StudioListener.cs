...
namespace FMODUnity
{
    ...
    public class StudioListener : MonoBehaviour
    {
        ...
        [SerializeField] private bool nonRigidbodyVelocity = false;

        [SerializeField] private GameObject attenuationObject = null;
        ...
        private void Update()
        {
            if (ListenerNumber < 0 || ListenerNumber >= CONSTANTS.MAX_LISTENERS)
            {
                return;
            }
